    ...
    members: [
      {
        id: "averin",
        name: "Аверин Андрей",
        category: "Тренер категории «Мастер», КМС",
        photo: "/images/team/averin.webp",
        bio: [
          "Тренерский стаж с 2005 года, кандидат в мастера спорта. Работает с игроками любого уровня — от первых шагов на корте до подготовки к соревнованиям.",
      ...
      },
      {
        ...
        bio: [
          ...
          "Кандидат в мастера спорта. Многократный победитель и призёр турниров TE, ITF и РТТ.",
      ...
      },
      {
        ...
        category: "Тренер категории «Профи», мастер спорта",
    ...
    members: [
      {
        ...
        bio: [
          "Мастер-тренер, стаж более 10 лет. Специализация — лёгкая атлетика.",
