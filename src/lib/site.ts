export const siteConfig = {
  ...
  /** Канонический адрес сайта (https, без www) */
  url: "https://tennis-impuls.ru",
  description:
    "Теннис, падел и фитнес в Мытищах: многофункциональный спортивный комплекс у Лосиного Острова — корты, групповые программы и зоны отдыха. Онлайн-бронирование.",
