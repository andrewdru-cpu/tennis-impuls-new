...
const features = [
  ...
  },
  {
    ...
    text: "Крытый Hard, открытый грунт и падел на одной территории. Профессиональное покрытие для игры в любое время.",
  },
  {
    icon: Dumbbell,
    title: "Фитнес и ОФП",
  ...
  },
  {
    ...
    text: "Закрытая территория более 1 га в экологически чистом районе — в 3 минутах от Москвы и МКАД.",
  },
  {
    icon: ParkingCircle,
    title: "Парковка и комфорт",
    text: "Бесплатная парковка, раздевалки с душем, VIP-зона с сауной и зона отдыха между тренировками.",
  },
];
          ...
          <div>
            ...
            <Reveal delay={0.16}>
              <p className="mt-6 text-card-body sm:text-base sm:leading-7">
                ...
                кондиционирования, открытые грунтовые площадки, падел,
                фитнес-центр и дополнительные направления — от детских групп до
                индивидуальных тренировок. Профессиональные тренеры,
            ...
            <Reveal delay={0.2}>
              <div className="mt-8 flex items-center gap-3 rounded-2xl bg-forest-900 px-5 py-4 text-white sm:px-6 sm:py-5">
                ...
                <p className="text-sm leading-relaxed sm:text-[0.9375rem] sm:leading-6">
                  ...
                  зона отдыха и спорт-бар — удобно провести время до и
                  после тренировки.
                </p>
              </div>
            </Reveal>
