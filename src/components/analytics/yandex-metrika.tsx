...
/**
 * Один loader tag.js (без ?id=) + два ym init в SSR HTML.
 * Яндекс.Директ смотрит View Source: ym(46954113) должен быть текстом страницы.
 */
const METRIKA_INLINE = `(function(m,e,t,r,i,k,a){
  ...
  return (
    <>
      <Script
        ...
        dangerouslySetInnerHTML={{ __html: METRIKA_INLINE }}
      />
      <noscript>
        <div>
